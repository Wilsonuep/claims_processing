...
Zależności
----------
    - claims_processing.core.retrieval.bm25               (BM25Index — zawsze dostępne)
    - claims_processing.pipeline.prepare.wikipedia_db       (knn_search — tylko w trybie vector/hybrid)
...
class RAGRetriever:
    ...
    def _init_vector(self, db_path: str) -> None:
        ...
        from claims_processing.pipeline.prepare.wikipedia_db import init_db
    ...
    def _retrieve_vector(self, query: str, k: int) -> list[dict[str, Any]]:
        ...
        from claims_processing.pipeline.prepare.wikipedia_db import knn_search
